...
Changes     : missing comma line 76 for arguments
              now passing by reference for bubble sort on line 52
...
int main()
{
    ...
    //making a call to testGene to run the test harness
    //this provides an output confirming all should have been completed accurately
    //testGene();
...
Changes     : value corrected to -0.7107 (line 154)
...
Changes     : removed [[maybe_unused]]
              vector now being passed into bubble sort by reference
